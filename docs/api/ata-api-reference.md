...
- **[Web BFF & WebSocket Capture](../research/web-bff-websocket-capture/README.md)** - Source HAR capture for the Schedules section above (WebSocket + `cloudschedule`); the Scenes and legacy-web Trend Summary sections come from a separate, broader HAR review the same week
