...
**Status:** Accepted — availability rules since amended by [ADR-020](020-unknown-for-missing-readings.md): a missing energy value reads `unknown`, not `unavailable`; ATW data source and the "updates hourly" rationale superseded by [ADR-027](027-atw-energy-from-combined-energy.md)
**Date:** 2025-11-19
