...
async def test_get_energy_consumed_hourly(
    ...
    result = await authenticated_client.atw.get_energy_consumed(
        unit_id=unit.id,
        from_time=from_time,
        to_time=to_time,
        interval="Hour",
...
async def test_get_energy_produced_hourly(
    ...
    assert unit is not None  # Type narrowing
    result = await authenticated_client.atw.get_energy_produced(
        unit_id=unit.id,
        from_time=from_time,
        to_time=to_time,
        interval="Hour",
...
@pytest.mark.asyncio
async def test_get_energy_consumed_requires_authentication() -> None:
...
@pytest.mark.asyncio
async def test_get_energy_produced_requires_authentication() -> None:
